  ...
  return (
    <>
      <div className="section flex my-6 lg:my-10">
        <div className="basis-2/5 lg:basis-5/12 flex justify-center">
          <img src={books} alt="books" className="" />
        </div>
        <div className="basis-3/5 lg:basis-7/12 flex ">
          <div className="self-center">
            <div className="text-[#525E85] text-7xl lg:text-6xl font-bold mb-2">
              Find Your Favorite
              <br /> Books Here
            </div>
            <div className="text-[#525E85] text-lg lg:text-base font-medium mb-2">
            ...
            <Link
              to="/all-books"
              className="button-read mt-6 bg-[#525E85] text-white w-[40%] py-1  flex justify-center rounded-full font-bold text-xl lg:text-lg cursor-pointer hover:scale-110 transition duration-300 ease-in-out"
            >
