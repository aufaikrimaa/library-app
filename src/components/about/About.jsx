    ...
    <>
      <div className="flex my-6 lg:my-10">
        <div className="basis-1/5  flex">
          <img src={booksCaseLeft} alt="books" className="h-[85vh]" />
        </div>
        <div className="basis-3/5 flex text-center">
          <div className="self-center">
            ...
            <div className="flex justify-center">
              <Link
                to="/all-books"
                className="button-read mt-6 bg-[#525E85] text-white w-[40%] py-1 rounded-full font-bold text-xl lg:text-lg cursor-pointer hover:scale-110 transition duration-300 ease-in-out"
              >
        ...
        <div className="basis-1/5 flex justify-end">
          <img src={booksCaseRight} alt="books" className="h-[85vh]" />
        </div>
      </div>
    </>
  );
